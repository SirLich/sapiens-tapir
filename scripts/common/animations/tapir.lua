...
local animationTypes = animationGroups.tapir.animations

animationInfo.modelTypeIndex = model:modelIndexForModelNameAndDetailLevel("tapir", 1)
animationInfo.default = animationTypes.stand1
